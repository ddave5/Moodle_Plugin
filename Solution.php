...
$sol = clone $task;
$nf2SolFilePath = "db/solutions/minta2nf" . date("Ymd"). ".txt";
...
$resultnf2 = shell_exec('python3 RelationDbScheme.py '. $nf2SolFilePath . ' ' . $nf2UserFilePath);

$sol = clone $task;
$nf3SolFilePath = "db/solutions/minta3nf" . date("Ymd"). ".txt";
...
Relaciosema::saveSolution($nf3Sol, $nf2SolFilePath);
Relaciosema::writeInputToTxt($nf3, $nf3UserFilePath);
$resultnf3 = shell_exec('python3 RelationDbScheme.py '. $nf3SolFilePath . ' ' . $nf3UserFilePath);

$sol = clone $task;
$bcnfSolFilePath = "db/solutions/mintabcnf" . date("Ymd"). ".txt";
...
Relaciosema::saveSolution($bcnfSol, $nf2SolFilePath);
Relaciosema::writeInputToTxt($bcnf, $bcnfUserFilePath);
$resultbcnf = shell_exec('python3 RelationDbScheme.py '. $bcnfSolFilePath . ' ' . $bcnfUserFilePath);
